...
Para realizar una prueba de nuestro código, en la función *when_started* agregaremos el siguiente código:
...
Del cual obtendremos la siguiente salida.
![1](https://i.imgur.com/JYWEBlM.jpg "Ejecución")
![2](https://i.imgur.com/Gma1Za4.jpg "Ejecución")
